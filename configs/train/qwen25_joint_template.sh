#!/bin/bash
# ==============================================================================
# PETRG-3D joint training with the Qwen2.5-7B-Instruct backbone.
#
...
experiment_name="petrg3d-qwen25-7B-joint"
bf16=True
master_port=25336

# -------------------- LLM backbone --------------------
lang_encoder_path="${LANG_ENCODER_PATH:-/path/to/Qwen2.5-7B-Instruct}"
