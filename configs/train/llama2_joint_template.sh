#!/bin/bash
# ==============================================================================
# PETRG-3D joint training with the Llama2-Chinese-7b-Chat backbone.
#
...
experiment_name="petrg3d-llama2-7B-joint"
bf16=True
master_port=25340

# -------------------- LLM backbone --------------------
lang_encoder_path="${LANG_ENCODER_PATH:-/path/to/Llama2-Chinese-7b-Chat}"
