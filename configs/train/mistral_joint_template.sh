#!/bin/bash
# ==============================================================================
# PETRG-3D joint training with the Mistral-7B-v0.3-Chinese-Chat backbone.
#
...
experiment_name="petrg3d-mistral-7B-joint"
bf16=True
master_port=25337

# -------------------- LLM backbone --------------------
lang_encoder_path="${LANG_ENCODER_PATH:-/path/to/Mistral-7B-v0.3-Chinese-Chat}"
